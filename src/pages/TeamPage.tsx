                ...
                <div className="flex overflow-x-auto pb-2 md:pb-0 gap-2 w-full md:w-auto no-scrollbar">
                    {departments.map(dept => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-colors ${filter === dept
                ...
                {filteredMembers.map((member) => (
                    ...
                    >
                        ...
                        <div className="relative mb-4">
                            ...
                            <div className={`absolute bottom-1 right-1 w-5 h-5 rounded-full border-4 border-dark-800 ${member.status === 'online' ? 'bg-green-500' :
