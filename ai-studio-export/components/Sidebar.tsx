...
const Sidebar: React.FC = () => {
  const navItems = [
    ...
    { name: 'Projeler', icon: FolderOpen, path: '/projects/new' }, // Pointing to new project flow for demo
    { name: 'Görevler', icon: CheckSquare, path: '/tasks/1' }, // Pointing to detail for demo
